...
- (void)initialization {
    ...
    _pathBackColor = [UIColor clmHex:0xf3f3f3];
    _pathFillColor = [UIColor clmHex:0xff6400];
    _strokeWidth = 2;//线宽默认为10
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_showProgressText) {
        ...
        NSDictionary *attributes = @{NSFontAttributeName:font, NSParagraphStyleAttributeName:textStyle,NSForegroundColorAttributeName:[UIColor clmHex:0xff6400]};
        //获得size
